...
class MY_Model extends CI_Model
{
    ...
    public function getMaxmin($parametro)
    {
       
        $query = $this->db->query("SELECT  ".$parametro."(".$this->primary_key.") AS VALUE FROM  ".$this->_table. "" );
        $row = $query->row();
        $value = $row->VALUE;
    ...
    public function insert_many($data, $skip_validation = FALSE)
    {
     ...
     public function insert_many_compra($data, $skip_validation = FALSE,$lote)
    {
        $ids = array();
