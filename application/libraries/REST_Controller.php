...
$this->response([
                'level' => $this->llave_user_level(),
                'segments' => $this->uri->segment(3),
                'user_id'   => $this->llave_user(),
                'key'       => $this->rest->key,
                $this->config->item('rest_status_field_name') => $this->config->item('fallo'),
                 $this->config->item('rest_message_field_name') => 'Su acceso no es valido',
                $this->config->item('data') =>  $this->lang->line('dataF')
...
*/
        ...
        //para inicio de session y registro de usuario
...
//este filtro valida que el usuario solo pueda acceder solo a su informacion
...
/*
        ...
        if ($this->config->item('rest_enable_keys')){
                      ...
                      $usr_datos = $this->Model_usr->llave_user($this->rest->key);


if ($this->uri->segment(3)){
                        if ($this->uri->segment(3) <> $usr_datos['user_id'] && $usr_datos['level'] <> 3){

                        $this->response([
                                'level' => $usr_datos['level'],
                                'segments' => $this->uri->segment(3),
                                'user_id'   => $usr_datos['user_id'],
                                $this->config->item('rest_status_field_name') => $this->config->item('fallo'),
                                 $this->config->item('rest_message_field_name') => 'Su acceso no es valido',
                                $this->config->item('data') =>  $this->lang->line('dataF')
