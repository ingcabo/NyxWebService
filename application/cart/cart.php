...
<?php         echo "<a href='/nix/site/wp-content/plugins/woocommerce/templates/cart/cart_g_compra.php?cart=".$url."' target='tuArchivo' onclick=\"window.open(this.href, this.target, ' width=1000, height=1000, menubar=no');return false;\"> <img src='../site/wp-content/uploads/gpago.png'> </a>"; ?>
